...
public class TunerConstants {
    ...
    private static final double kCoupleRatio = 0; // 6.3 / 1.5

    private static final double kDriveGearRatio = 6.3; // 1.5 azimuth motor rotations --> 1 drive wheel rotation
    ...
    private static final Angle kFrontRightEncoderOffset = Rotations.of(0.218994);
